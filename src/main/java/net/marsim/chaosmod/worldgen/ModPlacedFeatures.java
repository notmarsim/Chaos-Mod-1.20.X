...
public class ModPlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> STABLE_PARTICLE_ORE_PLACED_KEY = registerKey("stable_particle_ore_placed");
    public static final ResourceKey<PlacedFeature> DARKLIGHT_ORE_PLACED_KEY = registerKey("darklight_ore_placed");
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        register(context, STABLE_PARTICLE_ORE_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.OVERWORLD_STABLE_PARTICLE_ORE_KEY),
                ModOrePlacement.commonOrePlacement(5,
                        HeightRangePlacement.uniform(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(-20))));
        register(context, DARKLIGHT_ORE_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.OVERWORLD_DARKLIGHT_ORE_KEY),
                ModOrePlacement.commonOrePlacement(5,
                        HeightRangePlacement.uniform(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(-20))));
